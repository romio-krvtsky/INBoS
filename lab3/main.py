...
def run_attacks():
    ...
    # connection = Connection([client, server1, server2], [tcpResetMiddleware])
    # connection = Connection([client, server1, server2], [fakeIpAddressMiddleware])
    # connection = Connection([client, server1, server2], [rstMiddleware])
    connection = Connection([client, server1, server2], [connectionHijack])
